...
Filename: CWE90_LDAP_Injection__Servlet_getQueryStringServlet_53a.java
...
public class CWE90_LDAP_Injection__Servlet_getQueryStringServlet_53a extends AbstractTestCaseServlet
{
    ...
    public void bad(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE90_LDAP_Injection__Servlet_getQueryStringServlet_53b()).bad_sink(data , request, response);
    }
    ...
    private void goodG2B(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE90_LDAP_Injection__Servlet_getQueryStringServlet_53b()).goodG2B_sink(data , request, response);
    }
